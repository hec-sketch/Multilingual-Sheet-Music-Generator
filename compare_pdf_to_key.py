"""Compare any produced Aymara score against the hand-made answer key, staff line by staff line."""
...
def read(path, wanted_fonts, geometry_from=None):
    """{(page, staff): text} for the overlay in `wanted_fonts`, read left to right."""
    doc = fitz.open(path)
